              ...
              <div class="flex items-center gap-2">
                @for (preset of presetColors; track preset.color) {
                  <button
                    ...
                    [style.border-color]="
                      form.value.color === preset.color ? 'var(--accent)' : 'transparent'
                    "
                    [style.boxShadow]="
                      form.value.color === preset.color ? '0 0 0 3px rgba(59,130,246,0.35)' : 'none'
                    "
                  ></button>
                }
                <input
      ...
      @if (!loading() && environments().length === 0) {
        ...
        >
          ...
          <p class="text-xs mt-1" style="color: var(--text-muted)">
            Create at least one to start managing flags.
          </p>
        </div>
      }
          ...
          @for (env of environments(); track env.id) {
            ...
            >
              ...
              <div
                ...
                [style.background-color]="env.color ?? '#52525b'"
              ></div>
                ...
                <div class="flex items-center gap-2">
                  ...
                  @if (env.isDefault) {
                    <span
                      ...
                      style="color: var(--text-muted); background-color: var(--bg-elevated)"
                      >default</span
                    >
                  }
                </div>
