    ...
    <div class="p-6 max-w-5xl mx-auto">
      ...
      <div class="mb-6">
        <div class="flex items-center gap-2 text-xs mb-2" style="color: var(--text-muted)">
          <a routerLink="/tenants" class="transition-colors cursor-pointer hover:underline"
             style="color: var(--text-muted)">Tenants</a>
          <span>/</span>
        ...
        <div class="fixed inset-0 flex items-center justify-center z-50 px-4"
          ...
          <div class="border rounded-xl p-6 max-w-sm w-full"
            ...
            <p class="text-xs mb-4" style="color: var(--text-muted)">
              ...
              in <span class="font-medium" style="color: var(--text-primary)">{{ tenant()?.name }}</span>.
            </p>
            ...
            <div class="flex gap-2 mb-2">
              ...
              <button type="button" (click)="resetPassword.set(generatePwd())"
